...
function render(){
  recompute();
  /* เติมซับให้เคสที่ทะเบียนชี้ไปซับเดียวชัดเจนอยู่แล้ว รันเงียบ ๆ ทุกครั้งที่ render ไม่ว่าอยู่หน้าไหน
     (ไม่ใช่แค่หน้ากระดาน) ไม่ต้องรอให้ใครกดปุ่ม — ฟังก์ชันมีตัวกันชนในตัวอยู่แล้ว ไม่ยิงซ้อนกัน */
